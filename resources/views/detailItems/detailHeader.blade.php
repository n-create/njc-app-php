...
<div class="bk-detail-top-data mb-3">
  <div class="bk-detail-top-title-area mb-1">
    <div class="bk-detail-status-icons">
      <ul class="bk-icons"><?php if($searchManager->isNewArrive($detailData)) { ?>
    ...
    <div class="bk-detail-crui-name badge badge-dark mr-1 mb-1">
      <div class="bk-data-title">{{ $searchManager->getAndCheckBkData($detailData, $searchManager::BK_DATA_BILDTYPE, null) }}</div>
    </div>
