...
class MstBkSearch {
    ...
    const BK_DATA_CYUKYORI = 'syogaku_kyori';
    ...
    const BK_DATA_REALDATA = [
        ...
        self::BK_DATA_MONEY_ETC => [
            'key' => [
                ...
                'sikikin_zero' => '敷金無し',
                'reikin_zero' => '礼金無し',
                'sikikin_or_reikin_zero' => '敷金礼金どちらかが無し',
            ],
    ...
    const IMG_CATEGORY_NAME = [
        self::IMG_TYPE_MADORI       => '間取り',
        self::IMG_TYPE_MAP          => '地図',
        self::IMG_TYPE_GAIKAN       => '外観写真',
        self::IMG_TYPE_GAIKANPERS   => '外観写真',
        self::IMG_TYPE_NAIKAN       => '内観写真',
        self::IMG_TYPE_YOUSHITSU    => '内観写真',
        self::IMG_TYPE_WASHITSU     => '内観写真',
        self::IMG_TYPE_GENKAN       => '内観写真',
        self::IMG_TYPE_KITCHEN      => '内観写真',
        self::IMG_TYPE_BATH         => '内観写真',
        self::IMG_TYPE_TOILET       => '内観写真',
        self::IMG_TYPE_WASH         => '内観写真',
        self::IMG_TYPE_LIVING       => '内観写真',
        self::IMG_TYPE_BEDROOM      => '内観写真',
        self::IMG_TYPE_CHILDROOM    => '内観写真',
        self::IMG_TYPE_STORAGE      => '内観写真',
        self::IMG_TYPE_SECURITY     => 'その他',
        self::IMG_TYPE_FACILITY     => 'その他',
        self::IMG_TYPE_BELANDA      => 'その他',
        self::IMG_TYPE_YARD         => 'その他',
        self::IMG_TYPE_PARKING      => 'その他',
        self::IMG_TYPE_ENTRANCE     => 'その他',
        self::IMG_TYPE_OTHER        => 'その他',
        self::IMG_TYPE_KYOYU        => 'その他',
        self::IMG_TYPE_KUKAKU       => '区画図',
        self::IMG_TYPE_SYUHEN       => '周辺画像',
    ];
    ...
    public static $sortOrderList = [
        RS_STR_RENT => [
            'room_type,money_at' => '間取が広い順',
            'room_type_at,money_at' => '間取が狭い順',
            'money' => '賃料が高い順',
            'money_at' => '賃料が安い順',
            'area_size,money_at' => '面積が広い順',
            'area_size_at,money_at' => '面積が狭い順',
            'floor,money_at' => '階層が高い順',
            'floor_at,money_at' => '階層が低い順',
            'created,money_at' => '登録日が新しい順',
            'created_at,money_at' => '登録日が古い順',
            'updated,money_at' => '更新日が新しい順',
            'updated_at,money_at' => '更新日が古い順',
        ],
        RS_STR_SALE => [
            'room_type,money_at' => '間取が広い順',
            'room_type_at,money_at' => '間取が狭い順',
            'money' => '金額が高い順',
            'money_at' => '金額が安い順',
            'area_size,money_at' => '専有面積が広い順',
            'area_size_at,money_at' => '専有面積が狭い順',
            'floor_area_size,money_at' => '延床面積が広い順',
            'floor_area_size_at,money_at' => '延床面積が狭い順',
            'floor,money_at' => '階層が高い順',
            'floor_at,money_at' => '階層が低い順',
            'created,money_at' => '登録日が新しい順',
            'created_at,money_at' => '登録日が古い順',
